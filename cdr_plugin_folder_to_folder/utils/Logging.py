...
def log_message (level=None, message=None, data=None, duration=0, from_method=None, from_class=None):  return get_logging_queue().put_nowait ({"level":level    , "message":message, "data":data, "duration":duration, "from_method":calculate_from_method(from_method), "from_class":calculate_from_class(from_class)})

def log_critical(            message=None, data=None, duration=0, from_method=None, from_class=None):  return get_logging_queue().put_nowait({"level":"CRITICAL", "message":message, "data":data, "duration":duration, "from_method":calculate_from_method(from_method), "from_class":calculate_from_class(from_class)})
def log_debug   (            message=None, data=None, duration=0, from_method=None, from_class=None):  return get_logging_queue().put_nowait({"level":"DEBUG"   , "message":message, "data":data, "duration":duration, "from_method":calculate_from_method(from_method), "from_class":calculate_from_class(from_class)})
def log_error   (            message=None, data=None, duration=0, from_method=None, from_class=None):  return get_logging_queue().put_nowait({"level":"ERROR"   , "message":message, "data":data, "duration":duration, "from_method":calculate_from_method(from_method), "from_class":calculate_from_class(from_class)})
def log_info    (            message=None, data=None, duration=0, from_method=None, from_class=None):  return get_logging_queue().put_nowait({"level":"INFO"    , "message":message, "data":data, "duration":duration, "from_method":calculate_from_method(from_method), "from_class":calculate_from_class(from_class)})
def log_warning (            message=None, data=None, duration=0, from_method=None, from_class=None):  return get_logging_queue().put_nowait({"level":"WARNING" , "message":message, "data":data, "duration":duration, "from_method":calculate_from_method(from_method), "from_class":calculate_from_class(from_class)})